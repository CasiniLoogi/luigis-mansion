...
-->
[Build Status]: https://github.com/CasiniLoogi/luigis-mansion/actions/workflows/build.yml/badge.svg
[actions]: https://github.com/CasiniLoogi/luigis-mansion/actions/workflows/build.yml
<!---
Code progress URL:
...
- Clone the repository:
  ...
  ```sh
  git clone https://github.com/CasiniLoogi/luigis-mansion.git
  ```
